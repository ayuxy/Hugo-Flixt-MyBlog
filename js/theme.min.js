...
var Util = function() {
	...
	_createClass(Util, [{
		...
		value: function getScrollTop() {
			...
			return ((_document$documentEle = document.documentElement) !== null && _document$documentEle !== void 0 ? _document$documentEle : document.body)
				.scrollTop
		}
	}, {
		key: "isMobile",
		...
		value: function animateCSS(element, animation, reserved, callback) {
			...
			(_element$classList = element.classList)
			.add.apply(_element$classList, ["animate__animated"].concat(_toConsumableArray(animation)));
			element.addEventListener("animationend", function() {
				var _element$classList2;
				!reserved && (_element$classList2 = element.classList)
					.remove.apply(_element$classList2, ["animate__animated"].concat(_toConsumableArray(animation)));
		...
		value: function scrollIntoView(selector) {
			var element = selector.startsWith("#") ? document.getElementById(selector.slice(1)) : document.querySelector(selector);
...
var FixIt = function() {
	function FixIt() {
		...
		_defineProperty(this, "getSiteTime", function() {
			...
			$runTimes.innerHTML = "".concat(days, ", ")
				.concat(String(hours)
					.padStart(2, 0), ":")
	...
	_createClass(FixIt, [{
		...
		value: function initThemeColor() {
			...
			this._themeColorOnSwitchTheme = this._themeColorOnSwitchTheme || function() {
				$meta.content = _this3.isDark ? $meta.dataset.dark : $meta.dataset.light
			};
		...
		value: function initMenuDesktop() {
			this.util.forEach(document.querySelectorAll(".has-children, #header-desktop .language"), function($item) {
				$item.querySelector(".sub-menu")
					.style.minWidth = "".concat($item.offsetWidth - 8, "px")
			})
		}
	}, {
		key: "initMenuMobile",
		value: function initMenuMobile() {
			...
			$menuToggleMobile.addEventListener("click", function(event) {
				...
				_this4.disableScrollEvent = document.body.classList.contains("blur")
			}, false);
		...
		value: function initSwitchTheme() {
			...
			this.util.forEach(document.getElementsByClassName("theme-switch"), function($themeSwitch) {
				$themeSwitch.addEventListener("click", function() {
					...
					(_window$localStorage = window.localStorage) === null || _window$localStorage === void 0 ? void 0 : _window$localStorage.setItem("theme", _this5.isDark ? "dark" : "light");
					var _iterator = _createForOfIteratorHelper(_this5.switchThemeEventSet),
						_step;
					try {
			...
			if (isMobile) {
				...
				document.getElementById("search-cancel-mobile")
					.addEventListener("click", function() {
						...
						_this6._searchMobile && _this6._searchMobile.autocomplete.setVal("")
					}, false);
				...
				$searchClear.addEventListener("click", function() {
					$searchClear.style.display = "none";
					_this6._searchDesktop && _this6._searchDesktop.autocomplete.setVal("")
				}, false);
				...
				var autosearch = autocomplete("#search-input-".concat(suffix), {
					...
					source: function source(query, callback) {
						...
						if (searchConfig.type === "lunr") {
							var search = function search() {
								...
								_this6._index.search(query)
									.forEach(function(_ref) {
										...
										if (position > 0) {
											position += context.substr(position, 20)
												.lastIndexOf(" ") + 1;
										...
										Object.keys(metadata)
											.forEach(function(key) {
												title = title.replace(new RegExp("(".concat(key, ")"), "gi"), "<".concat(highlightTag, ">$1</")
													.concat(highlightTag, ">"));
												context = context.replace(new RegExp("(".concat(key, ")"), "gi"), "<".concat(highlightTag, ">$1</")
													.concat(highlightTag, ">"))
											});
										results[uri] = {
											uri: uri,
							...
							_this6._algoliaIndex = _this6._algoliaIndex || algoliasearch(searchConfig.algoliaAppID, searchConfig.algoliaSearchKey)
								.initIndex(searchConfig.algoliaIndex);
							_this6._algoliaIndex.search(query, {
									offset: 0,
					...
					templates: {
						suggestion: function suggestion(_ref5) {
							...
							return "<div><span class=\"suggestion-title\">".concat(title, "</span><span class=\"suggestion-date\">")
								.concat(date, "</span></div><div class=\"suggestion-context\">")
								.concat(context, "</div>")
						},
						empty: function empty(_ref6) {
							var query = _ref6.query;
							return "<div class=\"search-empty\">".concat(searchConfig.noResultsFound, ": <span class=\"search-query\">\"")
						...
						footer: function footer(_ref7) {
							...
							var _ref8 = searchConfig.type === "algolia" ? {
								...
								icon = _ref8.icon,
								href = _ref8.href;
							return "<div class=\"search-footer\">Search by <a href=\"".concat(href, "\" rel=\"noopener noreferrer\" target=\"_blank\">")
								.concat(icon, " ")
		...
		value: function initHighlight() {
			...
			this.util.forEach(document.querySelectorAll(".highlight > .chroma"), function($chroma) {
				...
				if ($codeElements.length) {
					...
					$title.insertAdjacentHTML("afterbegin", "<i class=\"fa-solid fa-code\" aria-hidden=\"true\"></i>");									
					...
					if (_this8.config.code.editable) {
						...
						$edit.insertAdjacentHTML("afterbegin", "<i class=\"fa-solid fa-key fa-fw\" title=\"".concat(_this8.config.code.editUnLockTitle, "\" aria-hidden=\"true\"></i>"));
					...
					if (_this8.config.code.copyTitle) {
						...
						var code = $code.innerText.trim();
						if (_this8.config.code.maxShownLines == true) {
							$chroma.classList.add("open")
						}
		...
		value: function initHeaderLink() {
			var svgIcons = ["#ac-food-strawberry", "#ac-food-mochi", "#ac-food-avocado", "#ac-food-popsicle"];
			for (var num = 1; num <= 6; num++) {
				this.util.forEach(document.querySelectorAll(".single .content > h" + num), function($header) {
					$header.classList.add("header-link");
					var randomIcon = svgIcons[Math.floor(Math.random() * svgIcons.length)];
					if(num == 3){
						$header.insertAdjacentHTML("afterbegin", "<a href='#" + $header.id + "' class='header-mark'><svg class='icon' aria-hidden='true'><use xlink:href='" + randomIcon + "'></use></svg></a>");
					}
				})
			}
		}
		...
		value: function initToc() {
			...
			if (document.getElementById("toc-static")
				.getAttribute("data-kept") === "true" || this.util.isTocStatic()) {
				...
				$toc.style.marginTop = "".concat($postMeta.offsetTop + $postMeta.clientHeight, "px");
				...
				var headerHeight = document.getElementById("header-desktop")
					.offsetHeight;
				document.querySelector(".container")
					.addEventListener("resize", function() {
						$toc.style.marginBottom = "".concat(document.querySelector(".container")
							.clientHeight - document.querySelector(".post-footer")
							.offsetTop, "px")
					});
				this._tocOnScroll = this._tocOnScroll || function() {
					...
					for (var i = 0; i < $headerLinkElements.length - 1; i++) {
						var thisTop = $headerLinkElements[i].getBoundingClientRect()
							.top;
						var nextTop = $headerLinkElements[i + 1].getBoundingClientRect()
							.top;
		...
		value: function initTocListener() {
			var _document$querySelect, _this10 = this;
			var $toc = document.getElementById("toc-auto");
			var $tocContentAuto = document.getElementById("toc-content-auto");
		...
		value: function initMermaid() {
			...
			this._mermaidOnSwitchTheme = this._mermaidOnSwitchTheme || function() {
				...
				if ($mermaidElements.length) {
					...
					var themes = (_this11$config$mermai = _this11.config.mermaid.themes) !== null && _this11$config$mermai !== void 0 ? _this11$config$mermai : ["neutral", "dark"];
					mermaid.initialize({
						startOnLoad: false,
					...
					_this11.util.forEach($mermaidElements, function($mermaid) {
						mermaid.render("svg-" + $mermaid.id, _this11.data[$mermaid.id], function(svgCode) {
		...
		value: function initEcharts() {
			...
			this._echartsOnSwitchTheme = this._echartsOnSwitchTheme || function() {
				...
				_this12._echartsArr = [];
				_this12.util.forEach(document.getElementsByClassName("echarts"), function($echarts) {
					var chart = echarts.init($echarts, _this12.isDark ? "dark" : "light", {
						renderer: "svg"
					});
		...
		value: function initTypeit() {
			...
			if (this.config.typeit) {
				...
				Object.values(typeitConfig.data)
		...
		value: function initComment() {
			var _this$config$comment, _this15 = this;
			if (!((_this$config$comment = this.config.comment) !== null && _this$config$comment !== void 0 && _this$config$comment.enable)) {
				return
			}
			...
			this.config.comment.expired && document.querySelector("#comments")
				.remove();
			if (this.config.comment.artalk) {
				...
				artalk.on("comments-loaded", function() {
					_this15.config.comment.artalk.lightgallery && _this15.initCommentLightGallery(".atk-comment .atk-content", "img:not([atk-emoticon])")
				});
				return artalk
			}
			...
			if (this.config.comment.utterances) {
				...
				this._utterancesOnSwitchTheme = this._utterancesOnSwitchTheme || function() {
					...
					var message = {
						type: "set-theme",
						theme: _this15.isDark ? utterancesConfig.darkTheme : utterancesConfig.lightTheme
					};
			...
			if (this.config.comment.twikoo) {
				...
				if (twikooConfig.lightgallery) {
					twikooConfig.onCommentLoaded = function() {
						_this15.initCommentLightGallery(".tk-comments .tk-content", "img:not(.tk-owo-emotion)")
					}
				}
			...
			if (this.config.comment.giscus) {
				...
				this._giscusOnSwitchTheme = this._giscusOnSwitchTheme || function() {
					...
					var message = {
						setConfig: {
							theme: _this15.isDark ? giscusConfig.darkTheme : giscusConfig.lightTheme
						}
					};
		...
		value: function initWatermark() {
			var _this$config$watermar, _document$querySelect4, _document$querySelect5;
			((_this$config$watermar = this.config.watermark) === null || _this$config$watermar === void 0 ? void 0 : _this$config$watermar.enable) && new Watermark({
				content: this.config.watermark.content || "".concat((_document$querySelect4 = (_document$querySelect5 = document.querySelector("footer .fixit-icon")) === null || _document$querySelect5 === void 0 ? void 0 : _document$querySelect5.outerHTML) !== null && _document$querySelect4 !== void 0 ? _document$querySelect4 : "", " FixIt Theme"),
		...
		value: function initFixItDecryptor() {
			var _this17 = this,
				_this$config$encrypti, _this$config$encrypti2;
		...
		value: function initAutoMark() {
			...
			window.addEventListener("beforeunload", function() {
				...
				(_window$localStorage2 = window.localStorage) === null || _window$localStorage2 === void 0 ? void 0 : _window$localStorage2.setItem("fixit-bookmark/#".concat(location.pathname), _this19.util.getScrollTop())
			});
			var scrollTop = Number((_window$localStorage3 = window.localStorage) === null || _window$localStorage3 === void 0 ? void 0 : _window$localStorage3.getItem("fixit-bookmark/#".concat(location.pathname)));
		...
		value: function onScroll() {
			...
			$backToTop === null || $backToTop === void 0 ? void 0 : $backToTop.addEventListener("click", function() {
			...
			window.addEventListener("scroll", function(event) {
				...
				var scrollPercent = Math.max(Math.min(100 * Math.max(_this20.newScrollTop, 0) / contentHeight, 100), 0);
				if ($readingProgressBar) {
					$readingProgressBar.style.setProperty("--progress", "".concat(scrollPercent.toFixed(2), "%"))
				}
				if ($fixedButtons) {
					if (scrollPercent > 1) {
						$fixedButtons.classList.remove("d-none", "animate__fadeOut");
						_this20.util.animateCSS($fixedButtons, ["animate__fadeIn"], true)
					} else {
						$fixedButtons.classList.remove("animate__fadeIn");
						_this20.util.animateCSS($fixedButtons, ["animate__fadeOut"], true, function() {
							$fixedButtons.classList.contains("animate__fadeOut") && $fixedButtons.classList.add("d-none")
						})
					}
					if ($backToTop) {
						$backToTop.querySelector("span")
							.innerText = "".concat(Math.round(scrollPercent), "%")
					}
				}
				var _iterator2 = _createForOfIteratorHelper(_this20.scrollEventSet),
					_step2;
				try {
					for (_iterator2.s(); !(_step2 = _iterator2.n())
						.done;) {
			...
			window.addEventListener("resize", function() {
				if (!_this21._resizeTimeout) {
					_this21._resizeTimeout = window.setTimeout(function() {
						...
						var _iterator3 = _createForOfIteratorHelper(_this21.resizeEventSet),
							_step3;
						try {
							for (_iterator3.s(); !(_step3 = _iterator3.n())
								.done;) {
		...
		value: function onClickMask() {
			...
			document.getElementById("mask")
				.addEventListener("click", function() {
					...
					var _iterator4 = _createForOfIteratorHelper(_this22.clickMaskEventSet),
						_step4;
					try {
						for (_iterator4.s(); !(_step4 = _iterator4.n())
							.done;) {
		...
		value: function init() {
			...
			try {
				...
				window.setTimeout(function() {
					...
					_this23.initComment();
					if (!((_this23$config$encryp = _this23.config.encryption) !== null && _this23$config$encryp !== void 0 && _this23$config$encryp.all)) {
						_this23.initToc();
